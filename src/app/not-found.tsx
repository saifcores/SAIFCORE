...
export default function NotFound() {
  return (
    <div className="relative flex min-h-[70vh] flex-col items-center justify-center overflow-hidden px-4 py-16">
      ...
      <div
        className="pointer-events-none absolute -top-24 left-1/2 h-72 w-[min(90vw,480px)] -translate-x-1/2 rounded-full bg-gradient-to-br from-indigo-600/30 via-blue-500/10 to-transparent blur-3xl"
        aria-hidden
      />
      ...
      <div className="relative w-full max-w-md text-center">
        ...
        <p className="mt-4 text-[var(--text-secondary)] leading-relaxed">
          ...
          the portfolio to explore work and contact options.
        </p>
