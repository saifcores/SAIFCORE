...
const REPO_URL = "https://github.com/saifcores/payment-platform-disaster-lab";

export async function CaseStudyPaymentDisasterLab() {
  const t = await getTranslations("caseStudyPaymentDisasterLab");
  const tCommon = await getTranslations("common");
  const messages = await getMessages();
  const content = messages.caseStudyPaymentDisasterLab;
