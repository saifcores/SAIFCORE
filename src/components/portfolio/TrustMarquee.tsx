      ...
      <div className="overflow-hidden" aria-hidden>
        <div className="trust-marquee-track flex w-max items-stretch gap-10 pr-10 sm:gap-14 md:gap-16">
          {loop.map((b, i) => (
            <div
              key={`${b.name}-${i}`}
              className="flex w-[120px] shrink-0 flex-col items-center justify-center gap-2 rounded-[16px] border border-[var(--border-subtle)] bg-[var(--bg-elevated)]/20 px-3 py-3 sm:w-[140px] sm:px-4 sm:py-4 md:w-[160px]"
            >
