...
const LIVE_URL = "https://ecom360pme.com/";

export async function CaseStudyEcom360() {
  const t = await getTranslations("caseStudyEcom360");
  const tCommon = await getTranslations("common");
  const messages = await getMessages();
  const content = messages.caseStudyEcom360;
            ...
            <div className="mt-6 grid gap-10 lg:mt-8 lg:grid-cols-[minmax(0,1.15fr)_minmax(0,0.85fr)] lg:items-end lg:gap-14">
              <div>
                ...
                <div className="mt-4 flex flex-wrap items-center gap-x-3 gap-y-1.5">
                  ...
                  <span className="inline-flex items-center gap-1.5 text-xs font-medium text-[var(--accent-strong)]">
                    <span
                ...
                <div className="mt-6 flex w-full flex-col gap-2 min-[420px]:flex-row min-[420px]:flex-wrap">
                  <a
                    ...
                    aria-label={`${t("liveCta")} (${opensInNewTab})`}
